...
**原因：** `.env` 文件被 `.gitignore` 忽略（这是正确的安全做法）
...
更多问题请查看 [FAQ](docs/FAQ.md) 或提交 [Issue](https://github.com/yourusername/mitaagent/issues)
---
...
- 🐛 **报告问题**: [GitHub Issues](https://github.com/yourusername/mitaagent/issues)
- 💡 **功能建议**: [GitHub Discussions](https://github.com/yourusername/mitaagent/discussions)
- 📧 **联系作者**: xiaoyulox520@163.com
